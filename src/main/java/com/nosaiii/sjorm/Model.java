...
public abstract class Model {
    ...
    public <T extends Model> T belongsTo(Class<T> targetModelClass, String... foreignKeyColumns) {
        ...
        ModelMetadata targetMetadata = SJORM.getInstance().getMetadata(targetModelClass);
     ...
     */
    private String[] getAutoGeneratedForeignKeyColumns(ModelMetadata targetMetadata) {
